...
[_display,_slide,_idcLbDropContentList,[_rightCol * _pW, 4 * _pH, _rightColW * _pW, 5 * _pH],format[""],""] call ExAd_fnc_createList;

_idcBtnOrderDrop = [_slideClass, "btnOrderDrop"] call ExAd_fnc_getNextIDC;
[_display,_slide,_idcBtnOrderDrop,[_leftCol*_pW, 9*_pH, _leftColW*_pW, 1*_pH],format["_this call fn_OrderDrop"],"Order Drop",""] call ExAd_fnc_createButton;