...
// ******************************************************************************************
	...
	Description: XM8 App Server Init for ExAd APOC Airdrop Port Server Files
--------------------------------------------------------------------*/
...
******************************************************************************************************** */
{
	...
	"APOC_AA_AdvancedBanking",
	"APOC_AA_UseExileLockerFunds",
	"APOC_AA_DamageOnWhenLanded",
	"APOC_AA_coolDownTime",
	"APOC_AA_Drops",
	"APOC_AA_Drop_Contents"
];